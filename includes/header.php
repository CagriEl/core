                    ...
                    <div class="navbar-default sidebar" role="navigation">
                        <div class="sidebar-nav navbar-collapse">
                            <ul class="nav" id="side-menu">
                                ...
                                <li <?php echo (CURRENT_PAGE == "analize_basla.php" || CURRENT_PAGE == "analize_basla.php") ? 'class="active"' : ''; ?>>
                                    <a href="#"><i class="fa fa-building fa-fw"></i> Firma<span class="fa arrow"></span></a>
                                    <ul class="nav nav-second-level">
                                        <li>
                                            <a href="analize_basla.php"><i class="fa fa-list fa-fw"></i>Analize Başla</a>
                                        </li>
                                    </ul>
                                </li>
